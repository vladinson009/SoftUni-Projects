function products(input) {
    ...
    while (action !== 'Shop!') {
        ...
        let product = action[1];
        let secondProduct = action[2];
        ...
        switch (command) {
            case 'Important':
                if (list.includes(product)) {
                    ...
                    let theProduct = list.splice(idx, 1);
                    theProduct = theProduct.toString();
                    list.unshift(theProduct);
                } else {
